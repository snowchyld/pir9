...
#[derive(Debug, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct FileSystemTypeResource {
    #[serde(rename = "type")]
    pub fs_type: String,
}
...
pub async fn get_media_files(_query: Query<MediaFileQuery>) -> Json<Vec<MediaFileResource>> {
    Json(vec![])
}
...
pub fn routes() -> Router<Arc<AppState>> {
    Router::new()
        ...
        .route("/mediafiles", get(get_media_files))
}
