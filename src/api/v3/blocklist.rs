...
#[derive(Debug, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct BlocklistResourcePagingResource {
    pub page: i32,
    pub page_size: i32,
    pub sort_key: String,
...
pub async fn get_blocklist(query: Query<BlocklistQuery>) -> Json<BlocklistResourcePagingResource> {
    Json(BlocklistResourcePagingResource {
